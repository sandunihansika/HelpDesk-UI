...
import {CompanyType, ComplaintType, TextBoxTypes} from '../../../shared/services/common/enum';
...
export class ComplaintFormComponent {
  ...
  constructor(private formbuilder: FormBuilder, private formvalidationhelpers: FormValidationHelpers, private customerservice: CustomerDetailsService) {
    this.complainTypeId = [
  ...
  addComplaint() {
    ...
    this.customerservice.addComplaint(this.complaintForm.value).subscribe(res => {
  ...
  patchToCustomer(customerValue) {
    ...
    this.complaintForm.patchValue({
      ...
      handlingCompany: customerValue.handlingCompany ? this.getHandlingCompanyName(customerValue.handlingCompany) : ''
    });
  }
